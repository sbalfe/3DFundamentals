...
public:
	...
	Vertex& Transform( Vertex& v ) const
	{
		...
		/* this transforms it within NDC for correct interpolation */
		v *= wInv;
		...
		// so that we can recover the attributes after interp., recovery just before the pixel is actually placed 
		v.pos.w = wInv;
